  ...
  for (const n of nodes) {
    if (seen.has(n.node_key)) {
      issues.push({
        ...
        scope: "node",
        node_key: n.node_key,
        message: `Chave de nó (node_key) duplicada: "${n.node_key}".`,
      });
    }
    seen.add(n.node_key);
  }
    ...
    if (!keywords || keywords.length === 0) {
      ...
      if (blanks > 0) {
        issues.push({
          ...
          scope: "trigger",
          field: "trigger_config.keywords",
          message: `${blanks} palavra${blanks === 1 ? "-chave está em branco" : "s-chave estão em branco"} — elas não corresponderão a nada.`,
        });
      }
    }
  }
    ...
    case "start": {
      ...
      if (!cfg.next_node_key) {
        issues.push({
          ...
          field: "next_node_key",
          message: "O nó de início (Start) deve apontar para um próximo nó.",
        });
        ...
        issues.push({
          ...
          node_key: node.node_key,
          field: "next_node_key",
          message: `O nó de início (Start) aponta para o nó inexistente "${cfg.next_node_key}".`,
        });
      }
      break;
    }
    ...
    case "send_message": {
      ...
      if (!cfg.next_node_key) {
        ...
        issues.push({
          ...
          node_key: node.node_key,
          field: "next_node_key",
          message: `O nó de envio de mensagem aponta para o nó inexistente "${cfg.next_node_key}".`,
        });
      }
      break;
    }
    ...
    case "send_media": {
      ...
      if (
        ...
        issues.push({
          ...
          node_key: node.node_key,
          field: "media_type",
          message: "O nó de envio de mídia precisa de um tipo de mídia (imagem, vídeo ou documento).",
        });
      }
      if (!cfg.media_url?.trim()) {
        issues.push({
          ...
          node_key: node.node_key,
          field: "media_url",
          message: "O nó de envio de mídia precisa de um arquivo (faça o upload de um antes de ativar).",
        });
      }
      ...
      if (!cfg.next_node_key) {
        issues.push({
          ...
          node_key: node.node_key,
          field: "next_node_key",
          message: "O nó de envio de mídia deve apontar para um próximo nó.",
        });
      } else if (!knownKeys.has(cfg.next_node_key)) {
        issues.push({
          severity: "error",
          ...
          node_key: node.node_key,
          field: "next_node_key",
          message: `O nó de envio de mídia aponta para o nó inexistente "${cfg.next_node_key}".`,
        });
      }
      break;
    }
    ...
    case "send_buttons": {
      ...
      if (btns.length < 1) {
        issues.push({
          ...
          node_key: node.node_key,
          field: "buttons",
          message: "O nó de botões de envio precisa de pelo menos um botão.",
        });
      }
      ...
      btns.forEach((b, i) => {
        ...
        if (!b.reply_id?.trim()) {
          issues.push({
            ...
            message: `O botão ${i + 1} precisa de um ID de resposta (reply_id).`,
          });
        ...
        if (!b.title?.trim()) {
          ...
          issues.push({
            ...
            node_key: node.node_key,
            field: `${field}.title`,
            message: `O título do botão ${i + 1} tem mais de ${INTERACTIVE_LIMITS.buttonTitleMaxLength} caracteres (limite do WhatsApp).`,
          });
        }
    ...
    case "send_list": {
      ...
      if (!cfg.text?.trim()) {
        issues.push({
          ...
          node_key: node.node_key,
          field: "text",
          message: "O nó de lista de envio precisa de um corpo de texto.",
        });
      }
      if (!cfg.button_label?.trim()) {
        issues.push({
          ...
          node_key: node.node_key,
          field: "button_label",
          message: "O nó de lista de envio precisa de um rótulo de botão (o texto de toque para expandir).",
        });
      }
      ...
      if (totalRows < 1) {
        issues.push({
          ...
          node_key: node.node_key,
          field: "sections",
          message: "O nó de lista de envio precisa de pelo menos uma linha.",
        });
      }
      if (totalRows > INTERACTIVE_LIMITS.maxListRowsTotal) {
        issues.push({
          ...
          node_key: node.node_key,
          field: "sections",
          message: `A lista de envio permite no máximo ${INTERACTIVE_LIMITS.maxListRowsTotal} linhas no total entre todas as seções.`,
        });
      }
      const seenIds = new Set<string>();
        ...
        rows.forEach((row, ri) => {
          ...
          if (!row.reply_id?.trim()) {
            issues.push({
              ...
              node_key: node.node_key,
              field: `${field}.reply_id`,
              message: `A linha ${ri + 1} na seção ${si + 1} precisa de um ID de resposta (reply_id).`,
            });
    ...
    case "collect_input": {
      ...
      if (!cfg.prompt_text?.trim()) {
        issues.push({
          ...
          node_key: node.node_key,
          field: "prompt_text",
          message: "O nó de coleta de dados precisa de uma pergunta (prompt) para enviar ao cliente.",
        });
      }
      if (!cfg.var_key?.trim()) {
        issues.push({
          ...
          node_key: node.node_key,
          field: "var_key",
          message: "O nó de coleta de dados precisa de uma var_key para armazenar a resposta.",
        });
        ...
        issues.push({
          ...
          node_key: node.node_key,
          field: "var_key",
          message: `A var_key "${cfg.var_key}" deve ser alfanumérica+sublinhado (underscore) e começar com uma letra ou sublinhado.`,
        });
      }
      if (!cfg.next_node_key) {
        issues.push({
          ...
          node_key: node.node_key,
          field: "next_node_key",
          message: "O nó de coleta de dados deve apontar para um próximo nó.",
        });
      } else if (!knownKeys.has(cfg.next_node_key)) {
        issues.push({
          severity: "error",
          ...
          node_key: node.node_key,
          field: "next_node_key",
          message: `O nó de coleta de dados aponta para o nó inexistente "${cfg.next_node_key}".`,
        });
      }
      break;
    }
    ...
    case "condition": {
      ...
      if (!cfg.subject_key?.trim()) {
        issues.push({
          ...
          node_key: node.node_key,
          field: "subject_key",
          message: "A condição precisa de uma chave de assunto (nome da variável, ID da tag ou nome do campo).",
        });
      }
      if (
        !cfg.operator ||
        ...
        issues.push({
          ...
          node_key: node.node_key,
          field: "value",
          message: `O operador "${cfg.operator}" geralmente espera um valor de comparação — um valor vazio corresponderá apenas a assuntos vazios.`,
        });
      }
      for (const branch of ["true_next", "false_next"] as const) {
        ...
        if (!key) {
          issues.push({
            ...
            node_key: node.node_key,
            field: branch,
            message: `A condição precisa de um nó para a ramificação "${branch === "true_next" ? "true" : "false"}".`,
          });
          ...
          issues.push({
            ...
            node_key: node.node_key,
            field: branch,
            message: `A ramificação "${branch}" da condição aponta para o nó inexistente "${key}".`,
          });
        }
      }
      break;
    ...
    case "set_tag": {
      ...
      if (!cfg.mode || !["add", "remove"].includes(cfg.mode)) {
        issues.push({
          ...
          node_key: node.node_key,
          field: "mode",
          message: "O nó de definir tag precisa de um modo (add ou remove).",
        });
      }
      if (!cfg.tag_id) {
        issues.push({
          ...
          node_key: node.node_key,
          field: "tag_id",
          message: "O nó de definir tag precisa de uma tag para aplicar.",
        });
      }
      if (!cfg.next_node_key) {
        issues.push({
          ...
          node_key: node.node_key,
          field: "next_node_key",
          message: "O nó de definir tag deve apontar para um próximo nó.",
        });
      } else if (!knownKeys.has(cfg.next_node_key)) {
        issues.push({
          severity: "error",
          ...
          node_key: node.node_key,
          field: "next_node_key",
          message: `O nó de definir tag aponta para o nó inexistente "${cfg.next_node_key}".`,
        });
      }
      break;
    }
