        ...
        <>
          ...
          <div>
            ...
            <p className="mt-1 text-[10px] text-muted-foreground">
              Interpole em prompts posteriores e notas de encaminhamento com{" "}
    ...
    case "end":
      return (
        <p className="text-xs text-muted-foreground">
          Nó terminal. Quando a execução alcança este nó, ela é marcada como
...
function SendMediaForm({
  ...
  return (
    <>
      ...
      <TextRow
        label="Legenda (opcional, mostrada abaixo da mídia)"
        value={cfg.caption ?? ""}
