  ...
  return (
    <section className="max-w-2xl animate-in fade-in-50 duration-200">
      <SettingsPanelHead
        ...
        description="A moeda usada para novos negócios e para os totais de funis e painéis."
      />
      <Card>
        <CardHeader>
          ...
          <CardDescription className="text-muted-foreground">
            Novos negócios usam esta moeda por padrão, e os totais de funis e
            painéis são exibidos nela. Negócios existentes mantêm a
