      ...
      if (data.registered === false && data.registration_error) {
        ...
        toast.success(
          data.phone_info?.verified_name
            ...
            : 'WhatsApp conectado. Os eventos começarão a chegar em menos de um minuto.',
        );
  ...
  async function handleTestConnection() {
    try {
      ...
      if (payload.connected) {
        ...
        setResetReason(payload.needs_reset ? 'token_corrupted' : payload.reason === 'meta_api_error' ? 'meta_api_error' : null);
        setStatusMessage(payload.message || '');
        toast.error(payload.message || 'A conexão com a API falhou');
      }
    } catch (err) {
  ...
  async function handleVerifyRegistration() {
    ...
    try {
      ...
      if (data.live) {
        ...
        toast.error(
          'Número não está totalmente registrado. Veja as verificações abaixo para saber qual etapa falhou.',
          { duration: 8000 },
        );
      }
      if (accountId) await fetchConfig(accountId);
    ...
    return (
      <section className="animate-in fade-in-50 duration-200">
        <SettingsPanelHead
          ...
          description="Conecte sua API do WhatsApp Business da Meta. Credenciais, webhook e etapas de configuração estão todos aqui."
        />
      ...
      <div className="space-y-6">
        ...
        <Alert className="bg-card border-border">
          ...
          <AlertDescription className="text-muted-foreground">
            {connectionStatus === 'connected'
              ? 'Seu token de acesso é autenticado com a Meta. Veja o Status de registro abaixo para verificar se os webhooks estão realmente conectados.'
              : statusMessage ||
          ...
          >
            <div className="flex items-center justify-between gap-2 flex-wrap">
              <div className="flex items-center gap-2">
                ...
                >
                  {isRegistered
                    ? 'Registrado — A Meta entregará os eventos para o wacrm'
            ...
            <AlertDescription className="text-muted-foreground mt-2 text-xs leading-relaxed">
              {isRegistered ? (
                ...
                <>
                  ...
                  2 etapas abaixo e clique em Salvar Configuração para
                  inscrevê-lo.
                </>
              )}
            </AlertDescription>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-xs text-muted-foreground">
                Uma string personalizada criada por você. Deve corresponder ao token definido nas configurações de webhook da Meta.
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                Necessário apenas para direcionar mensagens de <strong className="text-muted-foreground">entrada</strong>{' '}
                para um número de <strong className="text-muted-foreground">produção</strong>. Defina-o no{' '}
                <strong className="text-muted-foreground">
                  Gerenciador de Negócios da Meta → Contas do WhatsApp → Números de
                  Telefone → Verificação em duas etapas
                </strong>
                , depois cole-o aqui para que o wacrm possa inscrever o número —
                caso contrário, a Meta direcionará os eventos de entrada para o último aplicativo
                que os reivindicou (o sintoma que afeta segundos números em uma WABA compartilhada).{' '}
                Os <strong className="text-muted-foreground">números de teste da Meta</strong> não possuem
                PIN e já estão pré-registrados — deixe em branco para eles.
                Deixar em branco também mantém um registro existente inalterado.
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription className="text-muted-foreground">
              Use esta URL como o callback do webhook no Painel de Aplicativos da Meta.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-2">
              ...
              <AccordionItem className="border-border">
                ...
                <AccordionContent className="text-muted-foreground">
                  <ol className="list-decimal list-inside space-y-1 text-sm">
                    ...
                    <li>Preencha os detalhes do aplicativo e conclua a criação</li>
                  </ol>
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem className="border-border">
                ...
                <AccordionContent className="text-muted-foreground">
                  <ol className="list-decimal list-inside space-y-1 text-sm">
                    ...
                    <li>Encontre o &quot;WhatsApp&quot; e clique em &quot;Configurar&quot;</li>
              ...
              <AccordionItem className="border-border">
                ...
                <AccordionContent className="text-muted-foreground">
                  <ol className="list-decimal list-inside space-y-1 text-sm">
                    ...
                    <li>Cole a <strong className="text-foreground">URL de Callback do Webhook</strong> informada ao lado</li>
