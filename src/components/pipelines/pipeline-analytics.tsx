    ...
    <TooltipProvider>
      <div className="grid grid-cols-2 gap-3 rounded-xl border border-border bg-card/60 p-4 sm:grid-cols-3 xl:grid-cols-6">
        <Metric
          ...
          tooltip="Quantidade de todos os negócios neste funil que não estão marcados como Perdidos. Negócios ganhos ainda estão inclusos."
        />
        <Metric
        ...
        <Metric
          ...
          tooltip="Receita esperada: valor de cada negócio aberto × a probabilidade do seu estágio. Primeiro estágio ≈ 10%, estágios progridem até 90%, Ganho = 100%. Negócios perdidos são excluídos."
        />
        <Metric
