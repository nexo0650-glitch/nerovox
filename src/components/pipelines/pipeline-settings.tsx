...
export function PipelineSettings({
  ...
  async function handleRemoveStage(stageId: string) {
    ...
    const { count } = await supabase
      ...
      .eq("stage_id", stageId);
    if (count && count > 0) {
      toast.error("Mova ou exclua os negócios neste estágio primeiro");
      return;
    }
    const { error } = await supabase
      ...
      .eq("id", stageId);
    if (error) {
      toast.error("Falha ao excluir estágio");
      return;
    }
        ...
        {showDeleteConfirm ? (
            ...
            <div className="flex items-center gap-3 rounded-lg border border-red-500/30 bg-red-500/10 p-4">
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-muted-foreground">
                  Isso excluirá todos os negócios neste funil. Esta ação não pode ser
                  desfeita.
                </p>
              </div>
            </div>
          ...
          <>
            <div className="grid gap-4 py-2">
              ...
              <div className="grid gap-2">
                <Label className="text-muted-foreground">Estágios</Label>
                <DndContext
                  sensors={sensors}
                ...
                <div className="flex items-center gap-2">
                  <Input
                    ...
                    placeholder="Novo nome do estágio"
